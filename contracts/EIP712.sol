...
contract Test {
    ...
    function _verify(bytes32 data,  bytes memory signature) public pure returns (bool) {
        return keccak256(abi.encode(data)).toEthSignedMessageHash().recover(signature) == signer;
    }
